...
I've made a small start with [Using exec to jump](/blog/posts/2020/10/03/using-exec-to-jump/), but that's also the point. The things I see, and that grab my attention and help me improve my knowledge, are small. One of the keys to continuous improvement and learning is adding to one's knowledge base one small gem at a time.
