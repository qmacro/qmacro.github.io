...
description: How to find freshly booted Raspberry Pis on the network so they can be configured further.
tags:
  - raspberry-pi
  - shell
  - brambleweeny
...
![Google Wifi app]({{ "/images/2020/03/wifiapp.png" | url }})
...
![Raspberry Pi 4]( {{ "/images/2020/03/pi4.png" | url }})
