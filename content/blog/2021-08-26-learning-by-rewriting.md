...
I like to qualify my variables, so use `local` here, which is a synonym for `declare`. I wrote about this in [Understanding declare](/blog/posts/2020/10/08/understanding-declare/) in case you want to dig in further.
