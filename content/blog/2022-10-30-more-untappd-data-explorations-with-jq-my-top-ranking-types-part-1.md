...
Near the start of the previous post [Untappd data with jq - my top brewery countries](/blog/posts/2022/10/28/untappd-data-with-jq-my-top-brewery-countries/) there's an example of a checkin object; here are some of the properties:
