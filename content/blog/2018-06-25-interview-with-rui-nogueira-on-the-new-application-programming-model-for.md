...
DJ: Node.js, for example - and may be, I'm fishing here, maybe you
...
now starting with Java, Node.js, and in general what we always look at is
...
Node.js, I'm not the world's biggest fan of Java per se, but I value
